...
public class AccountBalanceServiceTest {
    ...
    public void getAccountBalanceByAccountNo() {
        ...
        assertEquals(account1.getCurrency(), balance1.getCurrency().toString());
        ...
        assertEquals(account2.getCurrency(), balance2.getCurrency().toString());
        ...
        assertEquals(account3.getCurrency(), balance3.getCurrency().toString());
